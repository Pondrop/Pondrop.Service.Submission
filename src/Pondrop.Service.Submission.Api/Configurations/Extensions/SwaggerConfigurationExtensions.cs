...
namespace Pondrop.Service.Submission.Api.Configurations.Extensions;
...
public static class SwaggerConfigurationExtensions
{
    ...
    internal static void AddSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Version = "v1",
                Title = "Pondrop.Service.Submission API",
                Description = "API endpoints for the Pondrop.Service.Submission API",
