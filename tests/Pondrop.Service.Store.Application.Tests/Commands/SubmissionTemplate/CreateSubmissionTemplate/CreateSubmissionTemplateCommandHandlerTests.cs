...
public class CreateSubmissionTemplateCommandHandlerTests
{
    ...
    public CreateSubmissionTemplateCommandHandlerTests()
    {
    ...
    //[Fact]
    //public async void CreateSubmissionTemplateCommand_ShouldSucceed()
    //{
    //    // arrange
    //    var cmd = SubmissionTemplateFaker.GetCreateSubmissionTemplateCommand();
    //    var item = SubmissionTemplateFaker.GetSubmissionTemplateRecord(cmd);
    //    _validatorMock
    ...
    [Fact]
    public async void CreateSubmissionTemplateCommand_WhenInvalid_ShouldFail()
    {
        // arrange
        var cmd = SubmissionTemplateFaker.GetCreateSubmissionTemplateCommand();
        var item = SubmissionTemplateFaker.GetSubmissionTemplateRecord(cmd);
    ...
    [Fact]
    public async void CreateSubmissionTemplateCommand_WhenAppendEventsFail_ShouldFail()
    {
        // arrange
        var cmd = SubmissionTemplateFaker.GetCreateSubmissionTemplateCommand();
        var item = SubmissionTemplateFaker.GetSubmissionTemplateRecord(cmd);
    ...
    [Fact]
    public async void CreateSubmissionTemplateCommand_WhenException_ShouldFail()
    {
        // arrange
        var cmd = SubmissionTemplateFaker.GetCreateSubmissionTemplateCommand();
        var item = SubmissionTemplateFaker.GetSubmissionTemplateRecord(cmd);
    ...
    [Fact]
    public async void CreateSubmissionTemplateCommand_WhenRetailerNotFound_ShouldFail()
    {
        // arrange
        var cmd = SubmissionTemplateFaker.GetCreateSubmissionTemplateCommand();
        var item = SubmissionTemplateFaker.GetSubmissionTemplateRecord(cmd);
    ...
    [Fact]
    public async void CreateSubmissionTemplateCommand_WhenSubmissionTypeNotFound_ShouldFail()
    {
        // arrange
        var cmd = SubmissionTemplateFaker.GetCreateSubmissionTemplateCommand();
        var item = SubmissionTemplateFaker.GetSubmissionTemplateRecord(cmd);
